...
<html lang="en">
  <head>
    ...
    <title>Men's Salon Management System | Contact us Page</title>
               ...
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <button type="submit" style="background-color: #990033; color: white;" class="btn btn-contact" name="submit" >Send Message</button>
                    </form>
                </div>
    </div>
